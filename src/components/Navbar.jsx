    ...
    <nav className="w-full z-50 bg-[#fff7ef] border-b border-yellow-300 py-2">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-4">
          <a href="#" className="text-gray-700 hover:text-orange-500 transition hover:underline hover:scale-105"><b>Predict College</b></a>
      ...
      {menuOpen && (
        <div className="md:hidden flex flex-col items-center space-y-2 py-4 bg-[#fff7ef] border-t border-yellow-200 animate-fade-in-down">
          <a href="#" className="text-gray-700 hover:text-orange-500 transition text-lg hover:underline hover:scale-105"><b>Predict College</b></a>
          <a href="#" className="text-gray-700 hover:text-orange-500 transition text-lg hover:underline hover:scale-105"><b>College List</b></a>
          <a href="#" className="text-gray-700 hover:text-orange-500 transition text-lg hover:underline hover:scale-105"><b>About</b></a>
